  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        <ul id="ulBtn' + j + '" class="img-box-ul"><a name="ulId' + j + '" class="article-more-link" href="javascript:;" onclick="loadjustifiedGallery(this)" target="_blank" rel="noopener">展开</a></ul>\
